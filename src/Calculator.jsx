    ...
    <Fragment>
      ...
      <footer style={{ textAlign: "center", margin: "60px 0px 60px 0px" }}>
        <span
          ...
          onClick={() =>
            window.open(
              "https://github.com/recklessly-lazy/dummy-calculator/tree/master"
            )
          }
        >
          <Tooltip title="github code" placement="bottom">
            {/* <button href="https://github.com/recklessly-lazy/dummy-calculator/tree/master" style={{outline: 'none'}}> */}
            {/* <img
                style={{
                  height: "40px",
                  width: "40px",
